...
Variable rates usually start cheaper, but a fixed rate locks your payment for the full term. The tool below models your specific numbers — pick a term length, enter your mortgage amount and rates, then test what would happen if the variable rate moves.
