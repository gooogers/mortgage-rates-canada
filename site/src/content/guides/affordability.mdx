...
When a lender decides how much to advance you, they are not asking what you are comfortable paying. They are running two debt-service ratios and a stress test against your documented income. The output is your **maximum approval** — a number that is often higher than what makes financial sense for your household. This guide explains exactly how those calculations work, what shrinks them, and how to figure out your real number, not just the maximum one.

Understanding the formulas matters for a practical reason: if you know your GDS and TDS ratios before you apply, you can structure your offer, your down payment, and your debt payoff in ways that materially change what you qualify for.
...
This guide shows you both. The tool below outputs the lender's maximum. The sections after explain how to stress-test that number against your own life.

## Try the affordability calculator

The tool below encodes the math: GDS/TDS ratios, the stress test at max(contract+2%, 5.25%), and CMHC insurance tiers. Enter your income, debts, property costs, and down payment to see your maximum purchase price.

<AffordabilityTool />

The output is the lender's mathematical maximum, not a recommendation. A useful exercise: run it once at today's rate, then run it again at a rate **1.5–2% higher**. If the second number's monthly payment would force lifestyle compression you aren't prepared to make, you have probably found your real ceiling — somewhere below the maximum approval. The fuller [payment calculator](/calculator) is the better tool once you have a target purchase price and want to model the monthly cash flow in detail.
...
This is why bank pre-approvals often surprise first-time buyers on the low side relative to the homes they have been viewing. The stress test is doing real work.
...
The B-lender route is not free. On a $500,000 mortgage, a 2% rate premium costs roughly $10,000 per year in additional interest. Use B-lenders as a bridge, not a destination — improve your credit or income documentation and refinance to an A-lender at renewal.
