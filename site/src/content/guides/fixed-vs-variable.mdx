...
Variable rates usually start cheaper, but a fixed rate locks your payment for five years. The tool below models your specific numbers — enter your mortgage amount and rates, then test what would happen if the variable rate rises.
