...
description: "The legal minimum is 5% on the first $500k, 10% above that, and 20% on homes over $1.5M — but the real decision is whether to put down 20% to skip CMHC premiums."
